...
backend.congregationMessage.addEnvironment("GOOGLE_CLIENT_ID", process.env.GOOGLE_CLIENT_ID ?? "");
backend.congregationMessage.addEnvironment("GOOGLE_CLIENT_SECRET", process.env.GOOGLE_CLIENT_SECRET ?? "");
backend.congregationMessage.addEnvironment("GOOGLE_CALENDAR_CALLBACK_URL", process.env.GOOGLE_CALENDAR_CALLBACK_URL ?? "");
backend.congregationMessage.addEnvironment("GOOGLE_TOKEN_ENCRYPTION_KEY", process.env.GOOGLE_TOKEN_ENCRYPTION_KEY ?? "");
...
congregationApi.addRoutes({
    ...
    integration: new HttpLambdaIntegration("CongregationMessageIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/congregation/member",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("CongregationMemberIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/congregation/member/remove",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("CongregationMemberRemoveIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/congregation/member/update",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("CongregationMemberUpdateIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
...
congregationApi.addRoutes({
    ...
    methods: [HttpMethod.GET],
    integration: new HttpLambdaIntegration("GoogleCalendarListIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
...
congregationApi.addRoutes({
    ...
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("GoogleCalendarEventsUpdateIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/calendar/google/events/delete",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("GoogleCalendarEventsDeleteIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/calendar/google/oauth/callback",
    methods: [HttpMethod.GET],
    authorizer: new HttpNoneAuthorizer(),
    integration: new HttpLambdaIntegration("GoogleCalendarOauthCallbackIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/announcements",
    methods: [HttpMethod.GET],
    integration: new HttpLambdaIntegration("AnnouncementsListIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/announcements/week",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("AnnouncementsWeekIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
...
congregationApi.addRoutes({
    ...
    methods: [HttpMethod.POST],
    authorizer: new HttpNoneAuthorizer(),
    integration: new HttpLambdaIntegration("ParkingRegistrationIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/parking/management",
    methods: [HttpMethod.GET, HttpMethod.POST],
    integration: new HttpLambdaIntegration("ParkingManagementIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/parking/registrations",
    methods: [HttpMethod.GET],
    integration: new HttpLambdaIntegration("ParkingRegistrationsIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/parking/registrations/status",
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("ParkingRegistrationsStatusIntegration", backend.congregationMessage.resources.lambda),
});
congregationApi.addRoutes({
    path: "/admin/users",
    methods: [HttpMethod.GET],
...
congregationApi.addRoutes({
    ...
    methods: [HttpMethod.POST],
    integration: new HttpLambdaIntegration("AdminUsersGroupsIntegration", backend.congregationMessage.resources.lambda),
});
backend.addOutput({
    custom: {
        API: {
